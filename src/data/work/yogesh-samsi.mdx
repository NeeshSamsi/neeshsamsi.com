...
The website was completely custom coded. The tech stack was Next.js with Typescript. Tailwind CSS for styling. The source code can be found on my GitHub repo - [neeshsamsi/yogeshsamsi](https://github.com/neeshsamsi/yogeshsamsi)
