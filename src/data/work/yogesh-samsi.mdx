...
The idea was to redesign the site to be more intentional. Lay out information aesthetically and functionally so that users are guided through the site efficiently.
