...
image: /clientwork/srot-foundation/image.jpg
...
<ImageWithPreview image="/clientwork/images/srot-foundation/1.png" alt="Parth Phalke teaching a group of children" width={848} height={672} />
...
* The website also acts as a repository of previous and upcoming activities by the foundation
  ...
  <ImageWithPreview image="/clientwork/images/srot-foundation/2.png" alt="Screenshot of the Our Team section" width={848} height={540} />
...
<ImageWithPreview image="/clientwork/images/srot-foundation/3.png" alt="Screenshot of the Our Story section" width={848} height={426} />
...
* Donations are streamlined through the Razorpay payments platform which allows support for custom fields such as PAN No. so that all information can be collected at once during the payment.
  ...
  <ImageWithPreview image="/clientwork/images/srot-foundation/4.png" alt="Screenshot showing information cards about volunteering and conducting workshops" width={848} height={655} />
...
side simple for me without bringing in complexities like Databases. The full source code can be found on my GitHub repo - [neeshsamsi/srot](https://github.com/neeshsamsi/srot)
...
<ImageWithPreview image="/clientwork/images/srot-foundation/srot.jpg" alt="Presentation of a couple of screens" width={848} height={477} />
