  ...
  return (
    <PrismicNextLink
      className={cn(
        ...
        "after:absolute after:bottom-0 after:left-0 after:h-[0.075em] after:w-full after:bg-current after:opacity-0 after:-translate-y-[0.2em] after:transition-all after:duration-150 after:ease-in-out",
