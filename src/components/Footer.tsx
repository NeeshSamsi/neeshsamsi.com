...
export default async function Footer() {
  ...
  return (
    ...
    >
      ...
      >
        <p className="-mb-4 text-[9cqw] font-medium">hello@</p>
        <p className="text-[13.5cqw] font-normal md:text-[14cqw]">
          neeshsamsi.com
        </p>
      </a>
    </GridWrapper>
...
function FooterLinkGroup({ title, links, className }: FooterLinkGroupProps) {
  return (
    ...
    >
      <h3 className="font-serif text-lg font-light md:text-xl">{title}</h3>
